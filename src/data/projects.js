...
export const projects = [
  {
    ...
    scope: [
      ...
      'Certified orbital welding inspection, utility tie-ins (steam, glycol, compressed air)',
    ...
    machinerySupplied: [
      ...
      'Stainless Steel Storage Silos with Dimpled Cooling Jackets',
  ...
  },
  {
    ...
    description: 'JK Dairy engaged AM Tradings to resolve processing bottlenecks, improve fat recovery margins, and modernize plant cleaning systems. AM Tradings audited the existing mechanical infrastructure, sourced self-cleaning centrifugal separation machinery, re-engineered the homogenization loop, and integrated automated multi-circuit Clean-In-Place (CIP) technology.',
    scope: [
    ...
    machinerySupplied: [
      ...
      'Mix-Proof Valve Manifold for Zero Cross-Contamination',
    ...
    consultancyInvolvement: [
      ...
      'Process piping modifications and hygienic zoning remediation',
  ...
  },
  {
    ...
    scope: [
      ...
      'Hygienic environmental design, effluent treatment guidelines, and power generation balance',
    ],
    machinerySupplied: [
      ...
      'Process Flow Schematic & P&ID Blueprints',
